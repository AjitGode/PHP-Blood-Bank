...
<?php include("top_nav.php"); ?>
    ...
    <div class="container" style="margin-top:70px;">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header text-primary text-center"><i class='fa fa-user-md'></i> Admin Login
		    ...
		    <div class="col-xs-12 col-sm-12 col-md-9 col-sm-offset-2 col-md-offset-3">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title text-center" style="padding:5px;font-size:16px;font-weight:bold"><span class="fa fa-user-md "> </span> LOGIN</h3>
                    </div>
