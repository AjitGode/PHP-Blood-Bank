		...
		<div class="row centered-form">
		    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-0 col-md-offset-0">
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title text-center" style="padding:5px;font-size:16px;font-weight:bold"><span class="fa fa-heart "> </span> Need Blood To Save Lifes</h3>
                    </div>
                    <div class="panel-body">
					<p id="errorBox"></p>
					<form autocomplete="off" method="post"  action="pnre.php" enctype="multipart/form-data">
						<div class="form-group">
							<label class="control-label text-primary">Patient Name</label>
							<input type="text"  name="NAME" value="<?php echo $row['pname']; ?>"  required id="NAME" class="form-control input-sm">
						</div>
						...
						<div class="form-group">
							...
							<option value="A1+">O+</option>
							<option value="A2+">O-</option>
						...
						<div class="form-group">
							...
							<input type="text"  class="form-control input-sm" name="EMAIL" value="<?php echo $row['pemail']; ?>" id="EMAIL">
						</div>
						<div class="form-group">
